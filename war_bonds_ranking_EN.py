...
st.write(f'Up to now，There are {m_owners} Bumpkin contributors。{g_owners} Goblin contributors。Bumpkin team has {m_tickets} bonds。Goblin team has {g_tickets} bonds。Total bonds quantity is {t_tickets}。')
